    ...
    return React.createElement('li', { style: cardStyle, 'data-testid': 'dsh-dafeiyu-settings' },
      ...
      status === 'unavailable'
        ...
        : React.createElement(React.Fragment, null,
          ...
          React.createElement(Field, { label: '完成语音提示', hint: '任务完成时播放语音「任务完成，请查收」。' },
            React.createElement('input', {
              type: 'checkbox', checked: value.completionVoice !== false, disabled: !writable,
              onChange: (event) => void write('completionVoice', event.target.checked),
            }),
          ),
